...
This Extension registers a PublishInboundInterceptor to forward Sparkplug (N/D) BIRTH certificates as Retained messages to an additional sparkplug system topic.
