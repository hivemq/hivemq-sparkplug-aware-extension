 ...
 * <p>
 * This class contains string constants that describe the mandatory and optional behaviors that a Sparkplug Aware MQTT
 * Server must implement according to the Sparkplug specification. These requirements cover:
 * <ul>
 ...
 * </ul>
 * <p>
 * The constants are used for logging, documentation, and verification purposes to ensure the extension complies with
 * the official Sparkplug specification requirements.
 * <p>
...
final class AwareRequirements {
     ...
     * <p>
     * Specifies that a Sparkplug Aware MQTT Server MUST publish NBIRTH messages to system topics following the format:
     ...
     * <p>
     * Specifies that a Sparkplug Aware MQTT Server MUST publish NBIRTH messages to system topics with the MQTT retained
     * flag set to {@code true}, ensuring new subscribers receive the latest birth certificate immediately.
     */
     ...
     * <p>
     * Specifies that a Sparkplug Aware MQTT Server MUST publish DBIRTH messages to system topics following the format:
     ...
     * <p>
     * Specifies that a Sparkplug Aware MQTT Server MUST publish DBIRTH messages to system topics with the MQTT retained
     * flag set to {@code true}, ensuring new subscribers receive the latest device birth certificate immediately.
     */
     ...
     * <p>
     * Specifies that a Sparkplug Aware MQTT Server MAY replace the timestamp of NDEATH messages. If it does modify the
     * timestamp, it MUST set it to the UTC time at which it attempts to deliver the NDEATH message to subscribed
     * clients, rather than the original Last Will and Testament (LWT) creation time.
     */
